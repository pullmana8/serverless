...
* [`src/clj/cljs_client/`](src/clj/cljs_client/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/cljs_client/`](src/cljs/cljs_client/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/cljs_client/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `cljs-client` project root directory
...
in the [`src/clj/cljs_client/`](src/clj/cljs_client/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/cljs_client/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns cljs-client.example
  (:require [cljs-client.config :as config])
